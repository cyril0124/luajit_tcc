-- 
-- source from https://github.com/nucular/tcclua, slightly modify by cyril0124(211998078@qq.com)
-- changelist:
...
--- Compatible version of TCC (currently `0.9.27`)
tcc.TCC_VERSION = "0.9.27"
...
function tcc.load(lib, home_path)
  ...
  tcc.install_dir = tcc.home_path

  -- lib = lib or (ffi.os == "Windows" and "libtcc" or "tcc")
  lib = lib or "libtcc.so"
...
function State:define_symbol(name, value)
  tcc.clib.tcc_define_symbol(self, name, value)
end

--- Undefine a preprocessor symbol.
-- @tparam string name name of the symbol
function State:undefine_symbol(name)
  tcc.clib.tcc_undefine_symbol(self, name)
end
